...
icinga = [
    ...
    'packages':['arsoft-base', 'icinga-common', 'icinga-core', 'icinga-cgi', 'icinga-doc', 'icinga-web', 'icinga-web-pnp', 'icinga-idoutils', 'icinga', 'pnp4nagios' ],
    'conflicts':['arsoft-nagios']
    },
    {'name':'none', 
