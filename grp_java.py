...
java = [
    ...
    'packages-yakkety':['openjdk-8-jre-headless'],
    'packages-zesty':['openjdk-8-jre-headless'],
    ...
    'packages-yakkety':['openjdk-8-jre'],
    'packages-zesty':['openjdk-8-jre'],
    ...
    'packages-yakkety':['openjdk-8-jdk'],
    'packages-zesty':['openjdk-8-jdk'],
    ...
    'packages-yakkety':['openjdk-8-jdk-headless'],
    'packages-zesty':['openjdk-8-jdk-headless'],
